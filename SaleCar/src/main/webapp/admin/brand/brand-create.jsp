...
<head>
    ...
    <title>Admin - Tạo Thương hiệu | LUXCAR</title>
    ...
    <style>
        ...
        * {
        ...
        /* ========== SIDEBAR STYLES (giữ nguyên từ trang quản lý) ========== */
        .sidebar {
            width: 280px;
...
<div class="d-flex">
    ...
    <main class="main-content">
        ...
        <header class="admin-header d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <h3 class="fw-bold m-0">
                    <i class="bi bi-building me-2" style="color:#2c7da0;"></i> Create Brand
                </h3>
        ...
        <div class="admin-card">
            <form action="/admin/brands/create" method="post" enctype="multipart/form-data" id="brandForm">
                <div class="row g-4">
                    <!-- Brand Name -->
                    <div class="col-md-6">
                        ...
                        <div class="logo-upload-container">
                            ...
                            <div class="logo-upload-zone">
                                <div id="dropZone"
                                    ...
                                    <p class="mb-2 fw-medium">Drag & drop logo here</p>
                                    <p class="text-muted small mb-3">PNG, JPG, WEBP up to 2MB</p>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="admin-textarea"
                                  ...
                                  name="description"
                                  rows="5"
                                  placeholder="Enter brand description...">${param.description}</textarea>
...
<script>
    ...
    function handleDrop(e) {
        ...
        if (files.length > 0) {
            logoInput.files = files; // Gán vào input
            handleFile(files[0]);
        }
    }
    ...
    // Reset form: clear preview khi nhấn nút Reset
    document.getElementById('resetBtn').addEventListener('click', function() {
        // Đợi form reset rồi mới clear preview (dùng setTimeout nhỏ)
        setTimeout(resetPreview, 10);
    });
</script>
</body>
</html>
