...
<html>
<head>
    <title>Xác nhận OTP - Quên mật khẩu | LUXCAR</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Steps indicator - 3 bước (bước 2 đang active) */
        .steps {
            display: flex;
            align-items: center;
            justify-content: center;
...
<div class="split-layout">
    <!-- LEFT PANEL (giữ nguyên nội dung) -->
    <div class="split-left">
        ...
        <ul class="feature-list">
            <li><div class="feat-icon"><i class="bi bi-envelope-paper-fill"></i></div><div class="feat-text"><strong>Mã xác nhận đã gửi</strong><span>Kiểm tra email để lấy mã OTP</span></div></li>
            ...
            <li><div class="feat-icon"><i class="bi bi-lock"></i></div><div class="feat-text"><strong>Đặt lại mật khẩu</strong><span>Tạo mật khẩu mới an toàn</span></div></li>
            <li><div class="feat-icon"><i class="bi bi-headset"></i></div><div class="feat-text"><strong>Hỗ trợ 24/7</strong><span>Đội ngũ chuyên nghiệp luôn sẵn sàng</span></div></li>
        </ul>
    </div>
    ...
    <div class="split-right">
        <div class="form-box">
            <div class="form-header">
                <h1>NHẬP MÃ OTP</h1>
                <div class="subtitle">Mã xác nhận đã được gửi đến email của bạn</div>
                <div class="sep"></div>
            </div>

            <!-- Steps indicator: bước 2 đang active -->
            <div class="steps">
            ...
            <form method="post" action="${pageContext.request.contextPath}/OTPforForgotPassword">
            ...
            <a href="${pageContext.request.contextPath}/OTPforForgotPassword" class="btn-secondary">GỬI LẠI MÃ</a>

            <div class="back-link">
                <a href="${pageContext.request.contextPath}/forgotPassword">← Quay lại</a>
            </div>
